/*
  # Fix team created_by field in signup flow
  
  1. Problem
    - New teams created during signup are missing created_by value
    - The complete_user_signup() function doesn't set this field
    
  2. Changes
    - Update complete_user_signup() to set created_by when creating teams
    - This ensures proper ownership tracking for new teams
*/
