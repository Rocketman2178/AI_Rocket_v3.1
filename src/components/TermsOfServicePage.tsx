        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">{TERMS_OF_SERVICE.title}</h1>
                <p className="text-sm text-gray-400">Last Updated: {TERMS_OF_SERVICE.lastUpdated}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-6 sm:p-8">
          <div className="prose prose-invert prose-blue max-w-none">
            <div className="legal-content text-gray-300 leading-relaxed">
              {TERMS_OF_SERVICE.content.split('\n\n').map((paragraph, index) => {
